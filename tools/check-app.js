...
assert(surface.includes("この条件で開始") && surface.includes("今日の射ちを記録する") && surface.includes("詳しく残す"), "record launch UI missing");
...
assert(surface.includes("この条件で開始") && surface.includes("前回と同じ") && surface.includes("recordQuickBar") && surface.includes("recordQuickRepeat") && surface.includes("quickStart") && surface.includes("quickStartMeta") && surface.includes("actionFaceLabel") && !surface.includes("今の条件で開始") && surface.includes("recordConditionRail") && surface.includes("recordTargetPreviewHtml") && surface.includes("recordSetupSnapshot") && surface.includes("gearHeroHtml"), "field-instrument record launch UI missing");
...
assert(surface.includes("levelFromScore") && surface.includes("summarySightDialHtml") && surface.includes("summaryDecisionHtml"), "record UI helpers missing");
...
assert(fs.existsSync(path.join(root, "tools", "build-native-web.js")) && fs.existsSync(path.join(root, "docs", "features", "native-transition.md")), "Native transition files missing");
...
assert(surface.includes("サイト値を残す") && surface.includes("サイト値つきで開始") && !surface.includes("校正用") && !surface.includes("状態確認"), "Record mode labels should be user-facing");
