...
assert(surface.includes("@keyframes appRise") && !surface.includes("primaryPulse") && surface.includes("scorePop") && surface.includes("markPop") && surface.includes("arrowFlight") && surface.includes("impactFlash") && surface.includes("triggerReleaseMotion") && surface.includes("shotNew") && surface.includes("freshArrow") && surface.includes("prefers-reduced-motion") && surface.includes("ic-record") && surface.includes("ic-sight"), "Quiet archery motion, tab icons, and reduced-motion guard missing");
