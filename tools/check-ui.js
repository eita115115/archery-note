...
function staticUiChecks() {
  ...
  assert(surface.includes("statusPill") && surface.includes("nativeSignal") && surface.includes("触感") && surface.includes("共有") && surface.includes("freshReload"), "native-feel UI missing");
