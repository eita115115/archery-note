...
function staticUiChecks() {
  ...
  assert(html.includes("判断信頼度") && html.includes("個人モデル") && html.includes("次のアクション") && html.includes("個人モデル育成度") && html.includes("スパイン初期候補") && html.includes("RK4-3D"), "analysis cards missing");
}
