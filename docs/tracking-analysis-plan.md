...
発展させる設計図とタスク列を定義する。
`docs/phase3-read-only-analysis-integration-plan.md` の制約に従い、
...
- dirty: `tools/check-ui.js` に未コミット変更。`AGENTS.md` / `CLAUDE.md` /
  `docs/codex-progress.md` / `docs/integration-plan.md` / `docs/codex-continue-prompt.md`
...
`docs/codex-progress.md` 自身が「ledger は現状と乖離、要再整合」と宣言している。
...
```text
/goal
Task 0: docs/codex-progress.md を現リポジトリ状態へ再整合する

Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。AGENTS.md、docs/codex-progress.md、
docs/tracking-analysis-plan.md（本プラン）、git log --oneline -10 の結果。

Requirement:
進行台帳 docs/codex-progress.md が実態（v1.0.0 リリース済み、APP_VER 64、
AGENTS.md 等が untracked、Phase Ledger の古い記述）と乖離している。
Current Status / Phase Ledger / Next Task Detail を現状に合わせて書き直し、
Next task を docs/tracking-analysis-plan.md の Task 1 に設定する。

Change scope:
- docs/codex-progress.md: 全面的な記述更新（docs-only）
Out of scope: アプリコード、他の docs、git commit の実施可否はユーザー指示に従う。

Done when:
- git status --short の実態と台帳の記述が一致している
- docs/tracking-analysis-plan.md への参照と Next task 設定が入っている
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の Task 1、
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の Task 2、
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の設計図 Layer 1 と
...
docs/tracking-analysis-plan.md の設計図 Layer 2 と Task 4、
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の Task 5、
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の A-2 と Task 6、
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の A-1 と Task 8、
sw.js、scripts/90-init.js（version.json?ts= と index.html?appv= の生成箇所)、
tools/check-pwa-update-flow.js、docs/pwa-update-safety-checklist.md。
...
Repo: C:\Users\eita2\Projects\archery-note
Read first: $archery-note を使用。docs/tracking-analysis-plan.md の A-6 と Task 9、
scripts/10-storage-native.js の load / normalizeDb、tests/fixtures/storage/、
tools/check-storage-roundtrip.js、docs/storage-migration-safety-checklist.md。
