...
const ICONS={
  ...
  left:'<svg class="icoInline" viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 10h11M5.5 5.5 3 10l2.5 4.5"/><path d="M17 4v12"/></svg>',
  right:'<svg class="icoInline" viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6 10h11M14.5 5.5 17 10l-2.5 4.5"/><path d="M3 4v12"/></svg>',
